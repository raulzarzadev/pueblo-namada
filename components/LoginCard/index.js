...
export default function LoginCard({ formVariant = 'login', formProps = {} }) {
  ...
  const formsOptions = {
    ...
    recover: {
      ...
      Component: <RecoverPassawordForm submitForm={recoverSubmit} {...formProps} buttonLabel='Enviar email' />
    },
    signup: {
      formLabel: 'Registrate',
      Component: <FormUser submitForm={signupSubmit} {...formProps} buttonLabel='Registrate' />
    }
  }
  ...
  return (
    <div className="flex justify-center items-center my-10 ">
      <div className="card w-auto bg-base-100 shadow-xl p-10">
        <h1 className="text-3xl font-bold text-center">{formsOptions[formVariant]?.formLabel}</h1>
