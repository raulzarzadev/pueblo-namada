...
const PrivatePage = (
  { children, permissionTo = 'private', elementOwner = null }:
  ...
  const AUTH_PAGES = {
    public: () => <>{children}</>,
    private: () => user ? <>{children}</> : <NoUserPage permissionTo={permissionTo} />,
    admin: () => user?.admin ? <>{children}</> : <NoUserPage permissionTo={permissionTo} />,
    owner: ({ elementOwner }: { elementOwner: string | null }) => user?.uid === elementOwner ? <>{children}</> : <NoUserPage permissionTo={permissionTo} />,
