...
export const createCashBalance = (newCashBalance: CashBalance) => CashBalancesCRUD.create(newCashBalance)
export const updateCashBalance = (CashBalanceId: string, newCashBalance: CashBalance) => CashBalancesCRUD.update(CashBalanceId, newCashBalance)
export const deleteCashBalance = (CashBalanceId: string) => CashBalancesCRUD.delete(CashBalanceId)
export const getCashBalance = (CashBalanceId: string) => CashBalancesCRUD.get(CashBalanceId)
export const listenCashBalance = (CashBalanceId: string, cb: CallableFunction) => CashBalancesCRUD.listen(CashBalanceId, cb)
export const listenPlaceCashBalances = (placeId: string, cb: CallableFunction) => CashBalancesCRUD.listenDocs([where('placeId', '==', placeId)], cb)
